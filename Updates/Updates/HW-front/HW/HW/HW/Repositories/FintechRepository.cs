...
namespace HW.Repositories
{
    ...
    public class FintechRepository : IFintechRepository
    {
		...
		public Dictionary<string, dynamic>  CalculateMean()
        {
        ...
        public Dictionary<string, dynamic> CalculateMedian()
        {
            List<FinTechModel> data = _context.monthly_expenses.ToList();
            List<int> numbers = data
                            .Select(num => num.Expense)
        ...
        public Dictionary<string, dynamic> CalculateMostAmountSpentOn()
        {
            List<FinTechModel> data = _context.monthly_expenses.ToList();
            List<int> numbers = data
                            .Select(num => num.Expense)
        ...
        public Dictionary<string, dynamic> CalculateLeastAmountSpentOn()
        {
            List<FinTechModel> data = _context.monthly_expenses.ToList();
            List<int> numbers = data
                            .Select(num => num.Expense)
